...
export const mockBillingEncounters: BillingEncounter[] = [
  ...
  },
  {
    ...
    allowedAmount: 3800.00,
    claimNumber: 'CLM2024011',
    errors: [],
    hasErrors: false,
  ...
  },
  {
    ...
    treatmentTime: '11:00 - 11:30',
    encounterType: 'Lab Work',
    ...
    errors: [mockErrors[4]], // ICD-10 code mismatch
    hasErrors: true,
    ...
    billingOverrideEnabled: false,
    insuranceLevels: [
      { level: 'primary', payer: 'UnitedHealth', present: true, billedTo: false, status: 'pending' }
    ]
  },
  {
    id: 'enc_013',
    ...
    allowedAmount: 5200.00,
    insuranceAmount: 5200.00,
  ...
  },
  {
    ...
    treatmentTime: '15:00 - 15:30',
    encounterType: 'Prescription Refill',
    provider: 'Dr. Iyer',
    department: 'Internal Medicine',
    primaryPayer: 'UnitedHealth',
    policyNumber: 'UI567890',
    ...
    billingOverrideEnabled: false,
    insuranceLevels: [
      { level: 'primary', payer: 'UnitedHealth', present: true, billedTo: false, status: 'ready' }
    ]
  },
  {
    id: 'enc_003',
