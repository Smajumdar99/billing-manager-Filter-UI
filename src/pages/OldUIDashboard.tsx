...
/**
 * OldUIDashboard Component
 * 
 * Dashboard page for Old UI approach with proper navigation structure
 ...
 */
export const OldUIDashboard: FC = () => {
  const navigate = useNavigate()
  
  // Set document title for better UX
  useDocumentTitle('Dashboard - Old UI')
  ...
  const handleMainNavigation = (itemName: string) => {
    ...
    // Dashboard is current page, so no navigation needed
  }
