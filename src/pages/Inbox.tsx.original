...
import UpcomingReminders, { ReminderType } from '../components/organisms/UpcomingReminders';
            ...
            <div className="px-4 pb-4">
              ...
              {activeTopTab === 'Reminders' && (
                <>
                  ...
                  {/* Conditionally render UpcomingReminders or the regular table view */}
                  {viewMode === 'upcoming' ? (
                    <UpcomingReminders 
                      reminders={reminderData} 
                      onReminderClick={(reminder) => {
                        // When a reminder is clicked, let's open the send reminder dialog
                        handleSendReminder(reminder.id);
                      }}
                      maxItems={10}
                      className="shadow-sm"
                    />
                  ) : (
                    // Regular reminders content for other view modes
                    <>
              ...
              {['Transactions Reviews', 'Upcoming Appointments', 'DrFirst Notifications', 'Birthdays', 'Unbilled Encounters', 'Authorization(s)'].includes(activeTopTab) && (
                isLoading ? (
                  <GenericSkeletonLoading />
                ) : (
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div className="flex flex-1 overflow-hidden">
                  ...
                  <div className="flex space-x-4">
                    <button 
                      className={`px-4 py-2 rounded-md text-sm font-medium ${
                        reminderRecipientType === 'staff' ? 'bg-blue-100 text-blue-800 border-2 border-blue-300' : 'bg-gray-100 text-gray-700 border border-gray-300'
                      }`}
                    ...
                    <button 
                      className={`px-4 py-2 rounded-md text-sm font-medium ${
                        reminderRecipientType === 'patient' ? 'bg-blue-100 text-blue-800 border-2 border-blue-300' : 'bg-gray-100 text-gray-700 border border-gray-300'
                      }`}
                    ...
                    <button 
                      className={`px-4 py-2 rounded-md text-sm font-medium ${
                        reminderRecipientType === 'group' ? 'bg-blue-100 text-blue-800 border-2 border-blue-300' : 'bg-gray-100 text-gray-700 border border-gray-300'
                      }`}
              ...
              <div className="w-1/3 bg-gray-50 border-l border-gray-200 p-4 overflow-y-auto">
