 ...
 * ADLPage Component
 * 
 * ADL (Activities of Daily Living) page for Old UI approach with proper navigation structure
 ...
 */
export const ADLPage: FC = () => {
  const navigate = useNavigate()
  
  // Set document title for better UX
  useDocumentTitle('ADL - Old UI')
  ...
  const handleMainNavigation = (itemName: string) => {
    ...
    // ADL is current page, so no navigation needed
  }
        ...
        <div className="min-h-full flex items-center justify-center p-4">
          <div className="max-w-md w-full text-center space-y-6">
            ...
            <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
              We're building comprehensive Activities of Daily Living assessment tools 
              to help track and monitor patient functional capabilities.
            </p>
