...
import GroupAppointmentForm from '../../molecules/GroupAppointmentForm/group-appointment-form'
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      >
                ...
                <TabsContent value="provider">
                  ...
                  <div className="p-4 space-y-4">
                    ...
                    <Card className="shadow-none border-gray-200">
                      ...
                      <CardContent className="p-4 grid grid-cols-2 gap-x-4 gap-y-3">
                        <div className="space-y-1">
                          <Label htmlFor="providerContactType" className="text-xs font-semibold text-gray-500 uppercase tracking-wide">*Contact Type:</Label>
                          <Select>
                            <SelectTrigger id="providerContactType" className="h-8 text-sm">
                        ...
                        <div className="space-y-1">
                          <Label htmlFor="providerLocation" className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Location:</Label>
                          <Select>
                            <SelectTrigger id="providerLocation" className="h-8 text-sm">
                              <SelectValue placeholder="-- Select Location --" />
                            </SelectTrigger>
                            <SelectContent>
                        ...
                        <div className="space-y-1">
                          <Label htmlFor="providerFacility" className="text-xs font-semibold text-gray-500 uppercase tracking-wide">*Facility:</Label>
                          <Select>
                            <SelectTrigger id="providerFacility" className="h-8 text-sm">
                        ...
                        <div className="space-y-1">
                          <Label htmlFor="providerTitle" className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Title:</Label>
                          <Input id="providerTitle" className="h-8 text-sm" />
                        </div>
                      </CardContent>
                    </Card>
                    {/* Date & Time Card */}
                    <Card className="shadow-none border-gray-200">
                      ...
                      <CardContent className="p-4">
                        <div className="space-y-3">
                          <div className="grid grid-cols-3 gap-4">
                            <div className="col-span-2 space-y-1">
                              <Label htmlFor="providerDate" className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Date:</Label>
                              <Input id="providerDate" type="date" className="h-8 text-sm" />
                            </div>
                            <div className="flex items-center pt-6">
                              <Checkbox id="providerAllDayEvent" className="h-3 w-3" />
                              <label htmlFor="providerAllDayEvent" className="ml-1.5 text-xs text-gray-600">All day event</label>
                            </div>
                          </div>
                          <div className="grid grid-cols-3 gap-4">
                            <div className="space-y-1">
                              <Label htmlFor="providerStartTime" className="text-xs text-gray-500">From</Label>
                              <Input id="providerStartTime" type="time" className="h-8 text-sm" />
                            </div>
                            <div className="space-y-1">
                              <Label htmlFor="providerEndTime" className="text-xs text-gray-500">To</Label>
                              <Input id="providerEndTime" type="time" className="h-8 text-sm" />
                            </div>
                            <div className="space-y-1">
                              <Label htmlFor="providerDuration" className="text-xs text-gray-500">Duration</Label>
                              <div className="flex items-center gap-1">
                                <Input id="providerDuration" type="number" min="0" className="h-8 text-sm flex-1" />
                                <span className="text-xs text-gray-500 whitespace-nowrap">min</span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="pt-1 space-y-2">
                            <div className="flex items-center">
                              <Checkbox id="providerRepeats" className="h-3 w-3" />
                              <label htmlFor="providerRepeats" className="ml-1.5 text-xs font-medium text-gray-700">Repeats</label>
                            </div>
                            <div className="ml-5 grid grid-cols-12 gap-2 items-center">
                              <span className="text-xs text-gray-600 col-span-2">every</span>
                              ...
                              <span className="text-xs text-gray-600 col-span-1">until</span>
                              <div className="col-span-3">
                                <Input id="providerRepeatUntil" type="date" className="h-8 text-sm" />
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <Card className="shadow-none border-gray-200">
                      <CardHeader className="bg-gray-50 border-b border-gray-200 py-2">
                        <CardTitle className="text-sm font-semibold text-gray-800">Provider</CardTitle>
                      </CardHeader>
                      <CardContent className="p-4">
                        <Select>
                          <SelectTrigger id="providerProvider" className="h-8 text-sm">
                            <SelectValue placeholder="Select Provider" />
                          </SelectTrigger>
                          <SelectContent>
                            <SelectItem value="admin-annie">Admin, Annie</SelectItem>
                    ...
                    <Card className="shadow-none border-gray-200">
                      ...
                      <CardContent className="p-4">
                        <Textarea id="providerComments" className="text-sm" rows={2} />
                      </CardContent>
                    </Card>
                  </div>
                </TabsContent>
                <TabsContent value="group">
                  {/* Group Appointment Form Content */}
                  <GroupAppointmentForm />
                </TabsContent>
                <TabsContent value="benefits">
                  {/* Benefits Appointment Form Content - Coming Soon */}
                  <div className="flex items-center justify-center h-32">
                    <span className="text-sm text-gray-500 font-semibold">Benefits appointments coming soon.</span>
                  </div>
                </TabsContent>
              </Tabs>
            </div>
        ...
        {/* Sticky Action Bar Footer for All Tabs */}
        <div className="bg-gray-50 px-6 py-3 border-t border-gray-200 flex justify-end items-center sticky bottom-0 left-0 right-0 z-20">
          <div className="flex gap-2">
            <Button
              type="button"
              variant="outline"
              size="sm"
              className="text-xs h-8 text-blue-600 border-blue-400"
            >
              Cancel
            </Button>
            <Button
            ...
            <Button
              type="submit"
              size="sm"
              className="text-xs h-8 bg-sky-500 hover:bg-sky-600 text-white"
            >
              Save Appointment
            </Button>
          </div>
