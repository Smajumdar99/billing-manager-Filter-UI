...
const Agreements: React.FC<AgreementsProps> = ({ 
  ...
  const [agreements, setAgreements] = useState<Agreement[]>([
    ...
    {
      id: '2', 
      title: 'Privacy and Confidentiality Agreement',
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="e.g., Treatment Plan Consent, Privacy Agreement..."
                    className="mt-1"
                  />
                </div>
          ...
          {agreements.length === 0 && !isAddingNew && (
            <div className="text-center py-8 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <p className="text-xs text-gray-500 mb-4">
                Create your first agreement to establish consent and acknowledgment requirements.
              </p>
              <Button 
                onClick={handleStartAdd}
                size="sm"
